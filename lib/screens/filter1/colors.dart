...
class AppColors {
  static const Color primaryBackground = Color.fromARGB(255, 86, 99, 255);
  static const Color secondaryBackground = Color.fromARGB(255, 238, 247, 255);
  static const Color ternaryBackground = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color accentElement = Color.fromARGB(38, 132, 141, 255);
