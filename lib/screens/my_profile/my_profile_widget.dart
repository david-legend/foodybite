...
import 'package:potbelly/screens/my_profile/values.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.topCenter,
                    child: Container(
                      margin: EdgeInsets.only(top: 272),
                      child: Text(
                        "100k",
                        textAlign: TextAlign.center,
                        style: TextStyle(
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    height: 35,
                    margin: EdgeInsets.only(left: 104, right: 12),
                    child: Opacity(
                      opacity: 0.8,
                      child: Image.asset(
                  ...
                  Align(
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        width: 14,
                        height: 25,
                        margin: EdgeInsets.only(left: 127, top: 13),
                        decoration: BoxDecoration(
                          boxShadow: [
                            BoxShadow(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          height: 36,
                                          margin: EdgeInsets.only(left: 21, top: 41, right: 15),
                                          child: Row(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            children: [
                                              Align(
                                              ...
                                              Align(
                                                alignment: Alignment.topLeft,
                                                child: Container(
                                                  margin: EdgeInsets.only(left: 27, top: 19),
                                                  child: Opacity(
                                                    opacity: 0.8,
                                                    child: Text(
                                                      "Followers",
                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 43,
                                  margin: EdgeInsets.only(left: 58, right: 61),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
                                      Align(
                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 19,
                                  margin: EdgeInsets.only(left: 80, right: 83),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
                                      Align(
                                                  ...
                                                  children: [
                                                    Align(
                                                      ...
                                                      child: Container(
                                                        width: 38,
                                                        height: 14,
                                                        margin: EdgeInsets.only(right: 119, bottom: 1),
                                                        decoration: BoxDecoration(
