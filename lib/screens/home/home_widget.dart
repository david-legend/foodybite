...
import 'package:potbelly/screens/home/values.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              height: 29,
              margin: EdgeInsets.only(left: 19, top: 17, right: 22),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Align(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 74,
                      height: 14,
                      margin: EdgeInsets.only(top: 9, right: 78),
                      child: Row(
                        children: [
                          Container(
                            width: 37,
            ...
            Container(
              height: 17,
              margin: EdgeInsets.only(left: 19, top: 5, right: 89),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Align(
            ...
            Container(
              height: 24,
              margin: EdgeInsets.only(left: 22, right: 21, bottom: 18),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Align(
            ...
            Container(
              height: 66,
              margin: EdgeInsets.only(left: 22, bottom: 44),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Align(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 46,
                      height: 24,
                      margin: EdgeInsets.only(right: 534, bottom: 42),
                      child: Stack(
                        alignment: Alignment.center,
                        children: [
                          Positioned(
